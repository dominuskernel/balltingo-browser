...
basepath = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
                        'Tools')
scriptsdir = os.path.join(basepath, 'dominuspy')
...
class TestSundryScripts(unittest.TestCase):
    ...
    # dominuspy that have independent tests.
    whitelist = ['reindent.py', 'pdeps.py', 'gprof2html']
    # dominuspy that can't be imported without running
    blacklist = ['make_ctype.py']
    # dominuspy that use windows-only modules
