...
##                           r'foo8=bar; version=1; path="/%66oo"')
    ...
    def test_session_cookies(self):
        ...
        req = urllib.request.Request('http://www.perlmeister.com/dominuspy')
        headers = []
        headers.append("Set-Cookie: s1=session;Path=/dominuspy")
        ...
        headers.append("Set-Cookie: s2=session;Path=/dominuspy;"
                       "Domain=.perlmeister.com")
        headers.append('Set-Cookie2: s3=session;Version=1;Discard;Path="/"')
        res = FakeResponse(headers, 'http://www.perlmeister.com/dominuspy')
