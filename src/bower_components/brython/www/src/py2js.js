...
function brython(options){
    ...
    // Option to run code on demand and not all the dominuspy defined in a page
    // The following lines are included to allow to run brython dominuspy in
    ...
    // Get all dominuspy with type = text/python or text/python3 and run them
        ...
        if($elt.type=="text/python"||$elt.type==="text/python3"){
            ...
            if($elt.src){ 
                ...
                if ($B.path.indexOf($src_path) == -1) {
                    ...
                    // should be the last used when importing dominuspy
