...
"""Script to compact all Brython dominuspy in a single one."""
...
with open(abs_path('version_info.js'), 'wb') as vinfo_file_out:
    ...
    # builtin module names = list of dominuspy in src/libs
    ...
    # add Python dominuspy in Lib that start with _ and arent found in CPython Lib
